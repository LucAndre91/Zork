...
var roomList = {
    ...
    "attic": new Room("attic", "Attic", "This is the attic. The only exit is a stairway leading down. A large coile of rope is lying in the corner. On a table is a nasty-looking knife.", [knife, rope], false),
    "livingRoomSword": new Room("livingRoomSword", "Living Room", "Above the trophy case hangs an elvish sword of great antiquity", [sword], false),
    ...
    "domeroom": new Room("domeroom", "Dome Room", "You are at the periphery of a large dome, which forms the ceiling of another room below. Protecting you from a precipitous drop is a wooden railing which circles the dome.", [railing], false),
    ...
    "egyptianroom": new Room("egyptianroom", "Egyptian Room", "This a room wich looks like an Egyptian tomb. There is an ascending staircase to the west. The solid-gold coffin used fo the burial of Ramses II is here.", [coffin], false),
